...
tf.concat([t1, t2], 2)  # [[1, 2, 3, 7, 8, 9], [4, 5, 6, 10, 11, 12]]

# tensor t3 with shape [2, 3]
# tensor t4 with shape [2, 3]
a1 = tf.shape(tf.concat([t1, t2], 0))  # [4, 3]
a2 = tf.shape(tf.concat([t1, t2], 1))  # [2, 6]
...
'''开始训练'''
# 用于保存模型
saver_path = '/home/stone/Y3S2Deeplearning/ModelSave/'  # 保存路径
